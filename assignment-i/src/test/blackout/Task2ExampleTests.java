...
public class Task2ExampleTests {
    ...
    //     controller.createSatellite("Satellite4", "RelaySatellite", 23581 + RADIUS_OF_JUPITER, Angle.fromDegrees(233));
    //     // assertListAreEqualIgnoringOrder(Arrays.asList("DeviceC", "Satellite2"), controller.communicableEntitiesInRange("Satellite1"));

    //     Satellite s1 = controller.findSatellite("Satellite1");
    //     Satellite s4 = controller.findSatellite("Satellite4");

    //     // assertEquals(s1.SatelliteInRangetoSatellite(s4), true);

    //     assertEquals(controller.communicableEntitiesInRange("Satellite1"), true);
    //}
}
