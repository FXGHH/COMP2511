...
public class GraphTest {
    ...
    public Graph<String> setupGraph() {
        Graph<String> graph = new Graph<String>();
        graph.addNode("A");
        graph.addNode("B");
        graph.addNode("C");
    ...
    @Test
    public void testGraphSelf() {
        Graph<String> graph = setupGraph();
        Iterator<String> iterGraph = graph.iterator();
        assertEquals("A", iterGraph.next());
        assertEquals("B", iterGraph.next());
        assertEquals("C", iterGraph.next());
        assertEquals("D", iterGraph.next());
        assertFalse(iterGraph.hasNext());
    }
}
