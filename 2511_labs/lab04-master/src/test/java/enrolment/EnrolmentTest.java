...
public class EnrolmentTest {
    ...
    @Test
    public void testComparator() throws InvalidEnrolmentException {
        // List<Student> students = parseStudentsCSV("/students.csv");
        Course cs1511 = new Course("COMP1511", "Programming Fundamentals");
        CourseOffering cs1511Offering = new CourseOffering(cs1511, "19T1");
        Student student1 = new Student("z5555554", "c", 3707, new String[] {"SENGAH"});
        Student student2 = new Student("z5555554", "b", 3707, new String[] {"SENGAH"});
        Student student3 = new Student("z5555554", "a", 3707, new String[] {"SENGAH"});
        cs1511Offering.addEnrolment(student1);
        cs1511Offering.addEnrolment(student2);
        cs1511Offering.addEnrolment(student3);
        List<Student> students = new ArrayList<>();
        students.add(student3);
        students.add(student2);
        students.add(student1);
        assertEquals(students, cs1511Offering.studentsEnrolledInCourse());
    }
}
